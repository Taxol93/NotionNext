...
const BLOG = {
  AUTHOR: 'Kai Xie', // 作者
  BIO: '深深漫', // 作者简介
  LINK: 'https://hexo.lovezzq.top', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '0bca361ed7784105881e5c5d3fd2f987', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || "Kai's BLOG", // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'Kai的自留地', // 站点描述，被notion中的页面描述覆盖
